...
<main id="primary" class="site-main fulpage-wrapper">
  ...
  <div class="swiper all-rooms-wrapper" id="all-rooms">
    <div class="swiper-wrapper all-rooms">
      <div class="swiper-slide room">
        <section id="hero" class="announce section">

		      <?php get_template_part('template-sections/section-hero'); ?>
...
/*						      if ( ! empty( $headline_title = get_field( 'section_media_single_headline_title' ) ) ) {
      ...
      <div class="gallery-part">
	      <?php /* if (!empty($gallery = get_field('section_media_single_gallery'))) : */?>
