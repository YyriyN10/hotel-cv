...
*/
  ...
  let defaultMenuImage = $('.custom-menu .menu .menu-item:first-child a').attr('data-image');

  const menuAnimatePicWrapper = $('.elements-wrapper .menu-pic img');

  menuAnimatePicWrapper.attr('src', defaultMenuImage );
