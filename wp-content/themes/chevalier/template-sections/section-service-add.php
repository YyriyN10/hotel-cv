    ...
    <?php /* blocks */ if (!empty($blocks = $section['blocks'])) : ?>
      <div class="row">
        <?php foreach ((array) $blocks as $block) : ?>
          <div class="leisure-item col-xs-12 col-sm-6 col-md-4 col-lg-4" data-modal-content="<?php echo $block['opys_poslugy']; ?>" data-modal-img="<?php echo $block['dodatkove_zobrazhennya_dlya_asplyvayuchogo_vikna']; ?>">
            ...
            <div class="card-box">
              <div class="card-box__thumbnail" style="min-height: 350px;">
                ...
                <?php /* image */ if (!empty($image = $block['image'])) : ?>
                  <img class="parallax-image" src="<?php echo $image; ?>" />
                <?php /* image end */ endif; ?>
              </div>
