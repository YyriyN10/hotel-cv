...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230902_chevalierhotel_bf9337afe764673c8087_20230902163448_archive.zip';
        const ARCHIVE_SIZE       = '83273379';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'bf9337a-02163448';
        const SECONDARY_PACKAGE_HASH = 'd6db8a4-02163448';
